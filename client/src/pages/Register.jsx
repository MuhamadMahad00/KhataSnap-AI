    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--background)', padding: '24px' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="card" style={{ padding: '32px' }}>
          <h2 style={{ fontSize: '22px', fontWeight: 800, marginBottom: '4px', textAlign: 'center' }}>Create Account</h2>
          <p style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '28px', textAlign: 'center' }}>Start managing your expenses with AI</p>
